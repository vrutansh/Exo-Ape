  ...
  return (
    <div ref={parent} className='w-full md:h-[100vh] h-[70vh] bg-white flex items-center justify-center overflow-hidden'>
       <div className='w-[40%] md:w-[25%] md:h-[85%] h-1/2 relative'>
         <div ref={first} className='w-20 h-[7rem] md:w-40 md:h-[15rem] -right-1/3 top-6  absolute'>
         ...
         <div ref={third} className='absolute md:w-[17rem] w-[9rem] aspect-video -left-[70%] -bottom-10 bg-red-400'>
